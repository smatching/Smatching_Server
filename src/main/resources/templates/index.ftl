...
<html>
    ...
    <div style="text-align:right; color:blue;"><a href="/admin/add" onclick="window.open(this.href, 'newwin', 'width=700,height=800,scrollbars=yes,resizable=yes,left=500,top=50');return false;"><h5>새로운 지원사업 공고 추가하기</h5></a><br></div>
